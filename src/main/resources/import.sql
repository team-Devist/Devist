...
insert into todos (todo_id, title, description, created_time, done_rate, username) values (2, 'spring 동영상 강의 보기', 'youtube spring 검색. www.youtube.com 화, 일 마다 하는 일', '2019-01-02 11:20:14.000', 0,'cjh5414');
...
insert into todos (todo_id, title, description, created_time, done_rate, username) values (7, '주1회 중 1회 완료', '주1회 중 1회 완료.', '2018-01-03 11:10:14.000', 0.0, 'cjh5414');


insert into repeat_day (repeat_type, todo_id, days_of_week) values ('FixedRepeatDay', 1, 127);
insert into repeat_day (repeat_type, todo_id, days_of_week) values ('FixedRepeatDay', 2, 66);
insert into repeat_day (repeat_type, todo_id, days_of_week) values ('FixedRepeatDay', 3, 4);
