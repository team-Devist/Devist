...
insert into repeat_day (repeat_type, todo_id, days_of_week) values ('FixedRepeatDay', 0, 127);
...
insert into daily_checks (daily_check_id, planed_date, is_done, todo_id) values (4, '2018-12-24', 0, 4);